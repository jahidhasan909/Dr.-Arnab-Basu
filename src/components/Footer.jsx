...
const ExecutiveFooter = () => {
  ...
  return (
    <footer className="relative mx-[187px] rounded-lg bg-white/10 text-slate-300 border-t border-white/10 pt-16 pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-12">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              {[
                ...
                <li key={link.id}>
                  ...
                  >
                    <span>{link.name}</span>
                    <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all text-emerald-400" />
                  </button>
                </li>
              ))}
            </ul>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm">
              <div className="flex items-start gap-3">
                <div className="p-2 rounded-lg bg-white/5 border border-white/10 text-emerald-400 shrink-0 mt-0.5">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-400">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={scrollToTop}
              className="p-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/15 hover:border-white/20 hover:text-white transition-all text-slate-300 flex items-center justify-center shrink-0"
